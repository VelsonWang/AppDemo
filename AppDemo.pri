!isEmpty(APPDEMO_PRI_INCLUDED):error("AppDemo.pri already included")
APPDEMO_PRI_INCLUDED = 1
...
isEmpty(IDE_DISPLAY_NAME):           IDE_DISPLAY_NAME = App Demo
isEmpty(IDE_ID):                     IDE_ID = AppDemo
isEmpty(IDE_CASED_ID):               IDE_CASED_ID = AppDemo
...
osx {
    ...
    IDE_LIBRARY_PATH = $$IDE_OUTPUT_PATH/$$IDE_LIBRARY_BASENAME/AppDemo
    IDE_PLUGIN_PATH  = $$IDE_LIBRARY_PATH/plugins
    IDE_DATA_PATH    = $$IDE_OUTPUT_PATH/share/AppDemo
    IDE_DOC_PATH     = $$IDE_OUTPUT_PATH/share/doc/AppDemo
    IDE_BIN_PATH     = $$IDE_OUTPUT_PATH/bin
    win32: \
        IDE_LIBEXEC_PATH = $$IDE_OUTPUT_PATH/bin
    else: \
        IDE_LIBEXEC_PATH = $$IDE_OUTPUT_PATH/libexec/AppDemo
    !isEqual(IDE_SOURCE_TREE, $$IDE_OUTPUT_PATH):copydata = 1

    LINK_LIBRARY_PATH = $$IDE_BUILD_TREE/$$IDE_LIBRARY_BASENAME/AppDemo
    LINK_PLUGIN_PATH  = $$LINK_LIBRARY_PATH/plugins

    INSTALL_LIBRARY_PATH = $$QTC_PREFIX/$$IDE_LIBRARY_BASENAME/AppDemo
    INSTALL_PLUGIN_PATH  = $$INSTALL_LIBRARY_PATH/plugins
    win32: \
        INSTALL_LIBEXEC_PATH = $$QTC_PREFIX/bin
    else: \
        INSTALL_LIBEXEC_PATH = $$QTC_PREFIX/libexec/AppDemo
    INSTALL_DATA_PATH    = $$QTC_PREFIX/share/AppDemo
    INSTALL_DOC_PATH     = $$QTC_PREFIX/share/doc/AppDemo
...
win32:exists($$IDE_SOURCE_TREE/lib/AppDemo) {
    # for .lib in case of binary package with dev package
    LIBS *= -L$$IDE_SOURCE_TREE/lib/AppDemo
    LIBS *= -L$$IDE_SOURCE_TREE/lib/AppDemo/plugins
}
